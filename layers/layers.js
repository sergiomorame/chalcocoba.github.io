...
var format_Chalco_2 = new ol.format.GeoJSON();
var features_Chalco_2 = format_Chalco_2.readFeatures(json_Chalco_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Chalco_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Chalco_2.addFeatures(features_Chalco_2);
var lyr_Chalco_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Chalco_2, 
                style: style_Chalco_2,
                popuplayertitle: 'Chalco',
                interactive: false,
                title: '<img src="styles/legend/Chalco_2.png" /> Chalco'
            });
...
lyr_Positron_0.setVisible(true);lyr_colonias_1.setVisible(true);lyr_Chalco_2.setVisible(true);lyr_IncidenciasAgua_3.setVisible(true);
var layersList = [lyr_Positron_0,lyr_colonias_1,lyr_Chalco_2,lyr_IncidenciasAgua_3];
lyr_colonias_1.set('fieldAliases', {'cve_igecem': 'cve_igecem', 'nom_mun': 'nom_mun', 'nom_col': 'nom_col', 'area_m': 'area_m', });
lyr_Chalco_2.set('fieldAliases', {'qc_id': 'qc_id', 'id': 'id', 'cveigecem': 'cveigecem', 'cveinegi': 'cveinegi', 'nom_mun': 'nom_mun', 'iddeleg': 'iddeleg', 'area_km2_o': 'area_km2_o', 'area_km2': 'area_km2', 'PobTotal': 'PobTotal', });
...
lyr_colonias_1.set('fieldImages', {'cve_igecem': 'TextEdit', 'nom_mun': 'TextEdit', 'nom_col': 'TextEdit', 'area_m': 'TextEdit', });
lyr_Chalco_2.set('fieldImages', {'qc_id': 'TextEdit', 'id': 'TextEdit', 'cveigecem': 'TextEdit', 'cveinegi': 'TextEdit', 'nom_mun': 'TextEdit', 'iddeleg': 'TextEdit', 'area_km2_o': 'TextEdit', 'area_km2': 'TextEdit', 'PobTotal': 'TextEdit', });
...
lyr_colonias_1.set('fieldLabels', {'cve_igecem': 'hidden field', 'nom_mun': 'hidden field', 'nom_col': 'inline label - always visible', 'area_m': 'hidden field', });
lyr_Chalco_2.set('fieldLabels', {'qc_id': 'hidden field', 'id': 'hidden field', 'cveigecem': 'hidden field', 'cveinegi': 'hidden field', 'nom_mun': 'hidden field', 'iddeleg': 'hidden field', 'area_km2_o': 'hidden field', 'area_km2': 'no label', 'PobTotal': 'no label', });
