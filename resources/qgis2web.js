...
map.getView().fit([-11021707.463180, 2169649.413514, -10981433.337548, 2194423.710228], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Incidencias del Agua Chalco de Cobarrubias</h2>';
        return titleElement;
    })(),
